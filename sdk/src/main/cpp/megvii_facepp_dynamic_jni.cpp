 ...
 */
    static jlong native_init(JNIEnv *env, jobject,
        ...
        int retcode = mg_facepp.CreateApiHandleWithMaxFaceCount(
...
//除了confidence其实都是float
    static jfloatArray native_get_facepp_config(
        ...
        jfloatArray retArray = env->NewFloatArray(12);
        ...
        float is_smooth = h->is_smooth;
        float is_back_camera=config.is_back_camera;
        ...
        env->SetFloatArrayRegion(retArray, 10, 1, &(is_smooth));
        env->SetFloatArrayRegion(retArray, 11, 1, &(is_back_camera));
    ...
    static jint native_set_facepp_config(JNIEnv *,
                                         ...
                                         jboolean is_smooth,
                                         jboolean is_back_camera,
                                         jboolean is_smooth_track,
                                         jboolean is_rect_Qualcomm,
                                         jfloat happy_confidence_filter,
                                         jfloat happy_threshold
    ) {
        ApiHandle *h = reinterpret_cast<ApiHandle *>(handle);
        ...
        config.is_back_camera=is_back_camera;
        h->is_smooth = is_smooth;
        config.work_load = 0.6;
        config.is_smooth_track = is_smooth_track;
        config.is_rect_Qualcomm = is_rect_Qualcomm;
        config.happy_confidence_filter = happy_confidence_filter;
        config.happy_threshold = happy_threshold;
...
//        LOGE("caiyixin track_id: %f", track_id);
    ...
    static jfloatArray native_land_mark(JNIEnv *env,
        ...
        if (h->is_smooth) {
            ...
            mg_facepp.GetLandmark(h->api, index, false, point_nr, buff);
        }
    ...
    static jfloatArray native_attribute(JNIEnv *env,
        ...
        env->SetFloatArrayRegion(retArray, 3, 1, &happy);
 ...
 */
    static JNINativeMethod gMethods[] = {
            ...
            {"nativeSetFaceppConfig",  "(JFFFFFFFFFFZZZZFF)I",            (void *) native_set_facepp_config},
