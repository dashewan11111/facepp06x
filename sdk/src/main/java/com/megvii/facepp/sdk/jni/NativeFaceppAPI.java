...
public class NativeFaceppAPI {
    ...
    public static native int nativeSetFaceppConfig(long handle, float minFaceSize, float rotation, float interval,
                                                   float detectionMode, float roi_left, float roi_top, float roi_right, float
                                                           roi_bottom, float face_confidence_filter, float one_face_tracking,boolean is_smooth,boolean is_back_camera,boolean is_smooth_track,
                                                   boolean is_rect_Qualcomm,float happy_confidence_filter,float happy_threshold );
    ...
    static {
        ...
        try {
            ...
            System.loadLibrary("MegviiFacepp");
