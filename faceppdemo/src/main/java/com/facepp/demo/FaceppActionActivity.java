...
public class FaceppActionActivity extends Activity implements OnClickListener {
    ...
    private float confidence_filter = 0.6f; // 100
    ...
    private boolean isStartRecorder, is3DPose, isDebug, isROIDetect, is106Points, isBackCamera, isFaceProperty,
            isOneFaceTrackig, isFaceCompare,isFacesmile,isPointsDraw,ispowertest,isdump;
    private int[] imageItemImages_gray = {R.drawable.record_gray, R.drawable.three_d_gray, R.drawable.debug_gray,
            R.drawable.icon_id_gray, R.drawable.point81, R.drawable.frontphone, R.drawable.faceproperty_gray, R.drawable.facecompare_gray,
            R.drawable.powertest_gray,R.drawable.dompimage_gray};
    private int[] imageItemImages_blue = {R.drawable.record_blue, R.drawable.three_d_blue, R.drawable.debug_blue,
            R.drawable.icon_id_blue, R.drawable.point106, R.drawable.backphone, R.drawable.faceproperty_blue, R.drawable.facecompare_blue,
            R.drawable.powertest_blue,R.drawable.dompimage_blue};
    private int[] imageItemTexts = {R.string.record, R.string.pose_3d, R.string.debug, R.string.roi, R.string.landmarks, R.string.front, R.string.attributes, R.string.face_compare,R.string.powertext,R.string.dumpimage};
    private int[] editItemStrs = {R.string.min_face, R.string.resolution, R.string.interval, R.string.one_face_trackig, R.string.trackig_mode,R.string.confidence_filter};

    private RelativeLayout[] imageItem_Rels;
    private RelativeLayout[] textItem_Rels;
    private TextView[] editItemTexts;
    private String[] editValues = {min_face_size + "", resolution, detection_interval + "", "NO", "Track",confidence_filter+""};
...
//        }, 500);
    ...
    private void init() {
        ...
        RelativeLayout rel8 = (RelativeLayout) findViewById(R.id.landmark_imageitem_8);
        RelativeLayout rel9 = (RelativeLayout) findViewById(R.id.landmark_imageitem_9);
        imageItem_Rels = new RelativeLayout[]{rel0, rel1, rel2, rel3, rel4, rel5, rel6, rel7, rel8, rel9};
        ...
        RelativeLayout textRel5 = (RelativeLayout) findViewById(R.id.landmark_edititem_5);
        textItem_Rels = new RelativeLayout[]{textRel0, textRel1, textRel2, textRel3, textRel4,textRel5};
    ...
    public void onClick(View v) {
        ...
        }else if (ID == R.id.landmark_edititem_5){
            mDialogUtil.showEditText(editItemTexts[5], 5);
...
//            Toast.makeText(FaceppActionActivity.this,"开发中",Toast.LENGTH_SHORT).show();
        ...
        } else if (ID == R.id.landmark_imageitem_3) { //人脸关键点画点

            isPointsDraw = !isPointsDraw;
            onclickImageItem(3, isPointsDraw);
            ...
            isBackCamera = !isBackCamera;// true 是后置摄像
            onclickImageItem(5, isBackCamera);
            getCameraSizeList();
            min_face_size=isBackCamera?20:40;
            editItemTexts[0].setText(min_face_size+"");
        } else if (ID == R.id.landmark_imageitem_6) {
            isFaceProperty = !isFaceProperty;
            onclickImageItem(6, isFaceProperty);
            //
        } else if (ID == R.id.landmark_imageitem_7) {
            Toast.makeText(FaceppActionActivity.this,"暂不支持",Toast.LENGTH_SHORT).show();
...
//            }
//            onclickImageItem(7, isFaceCompare);
        }else if(ID == R.id.landmark_imageitem_8)
        {
            ispowertest = !ispowertest;
            onclickImageItem(8, ispowertest);
        }
        else if(ID == R.id.landmark_imageitem_9)
        {
            isdump = !isdump;
            onclickImageItem(9, isdump);
        }
            ...
            confidence_filter= Float.parseFloat(editItemTexts[5].getText().toString());
            ...
            faceActionInfo.confidenceFilter = confidence_filter;
            ...
            faceActionInfo.isFacePoint = isPointsDraw;//画关键点
            faceActionInfo.isFacesmile = isFacesmile;
