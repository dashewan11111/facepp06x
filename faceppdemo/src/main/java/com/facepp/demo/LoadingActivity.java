...
//        }
    ...
    private void network() {
        byte[] modelData = ConUtil.getFileContent(this, R.raw.megviifacepp_model);
        ...
        long time = Facepp.getApiExpirationMillis(this, modelData);
        ...
        Log.e("megvii", "megvii model info expireTime= " + (new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA).format(new Date(time))));
